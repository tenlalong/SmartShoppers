...
public class ManagerLogin extends JFrame {
	...
	public ManagerLogin() {
		...
		lblNewLabel.setBounds(43, 16, 214, 40);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Manager Username");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblNewLabel_1.setBounds(10, 67, 111, 19);
		...
		lblNewLabel_2.setBounds(10, 125, 111, 19);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Connection Con = DriverManager.getConnection(""
							+ "jdbc:mysql://localhost:3306/RegistrationInfo","root", "tenlalong");
					Statement stmt = Con.createStatement();
					String sql = "SELECT * FROM manager WHERE userName ='"
							+ ""+textField.getText()+"' and passw= '"+passwordField.getText().toString()+"'";
